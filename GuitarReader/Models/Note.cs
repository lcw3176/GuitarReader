...
namespace GuitarReader.Models
{
    public class Note
    {
        ...
        /// 음표 문자열
        /// </summary>
        public string CodeStr { get { return dict.FirstOrDefault(x => x.Value == (stringPos, fretPos)).Key; } }
        ...
        private int[] c = { 16, 33, 65, 131, 254, 523, 1047, 2093, 4186 };
        private int[] cs = { 17, 35, 69, 135, 270, 554, 1109, 2218, 4435 };
        private int[] d = { 18, 37, 73, 143, 287, 587, 1175, 2349, 4699 };
        private int[] ds = { 20, 39, 78, 156, 297, 622, 1245, 2489, 4978 };
        private int[] e = { 21, 41, 82, 165, 318, 659, 1319, 2637, 5274 };
        private int[] f = { 22, 44, 87, 175, 343, 699, 1397, 2794, 5588 };
        private int[] fs = { 23, 46, 93, 185, 356, 740, 1475, 2960, 5920 };
        private int[] g = { 25, 49, 98, 196, 387, 784, 1568, 3136, 6272 };
        private int[] gs = { 26, 52, 104, 208, 405, 831, 1661, 3322, 6645 };
        private int[] a = { 28, 55, 110, 220, 424, 880, 1760, 3520, 7040 };
        private int[] asharp = { 29, 58, 117, 233, 445, 932, 1865 ,3729, 7459 };
        private int[] b = { 31 ,62 ,124 ,241 , 469, 988 ,1976 ,3951 ,7902 };
